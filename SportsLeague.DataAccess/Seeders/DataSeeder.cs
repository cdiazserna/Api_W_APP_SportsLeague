...
namespace SportsLeague.DataAccess.Seeders
{
    public static class DataSeeder
    {
        public static async Task SeedAsync(LeagueDbContext context)
        {
            ...
            {
                new() { Name="Atlético Nacional", City="Medellín", Stadium="Atanasio Girardot", FoundedDate=DateTime.Parse("1947-03-07") },
                new() { Name="Independiente Medellín", City="Medellín", Stadium="Atanasio Girardot", FoundedDate=DateTime.Parse("1913-11-14") },
                new() { Name="América de Cali", City="Cali", Stadium="Pascual Guerrero", FoundedDate=DateTime.Parse("1927-02-13") },
                new() { Name="Deportivo Cali", City="Cali", Stadium="Deportivo Cali", FoundedDate=DateTime.Parse("1912-05-23") },
                new() { Name="Junior FC", City="Barranquilla", Stadium="Metropolitano", FoundedDate=DateTime.Parse("1924-08-07") },
                new() { Name="Millonarios FC", City="Bogotá", Stadium="El Campín", FoundedDate=DateTime.Parse("1946-06-18") },
                new() { Name="Independiente Santa Fe", City="Bogotá", Stadium="El Campín", FoundedDate=DateTime.Parse("1941-02-28") },
                new() { Name="Deportes Tolima", City="Ibagué", Stadium="Manuel Murillo Toro", FoundedDate=DateTime.Parse("1954-12-18") },
                new() { Name="Atlético Bucaramanga", City="Bucaramanga", Stadium="Alfonso López", FoundedDate=DateTime.Parse("1949-05-11") },
                new() { Name="Once Caldas", City="Manizales", Stadium="Palogrande", FoundedDate=DateTime.Parse("1961-02-15") },
                new() { Name="Deportivo Pasto", City="Pasto", Stadium="Departamental Libertad", FoundedDate=DateTime.Parse("1949-01-12") },
                new() { Name="Deportivo Pereira", City="Pereira", Stadium="Hernán Ramírez Villegas", FoundedDate=DateTime.Parse("1944-01-12") },
                new() { Name="Águilas Doradas", City="Rionegro", Stadium="Alberto Grisales", FoundedDate=DateTime.Parse("2008-01-01") },
                new() { Name="Boyacá Chicó FC", City="Tunja", Stadium="La Independencia", FoundedDate=DateTime.Parse("2002-01-01") },
                new() { Name="Jaguares de Córdoba", City="Montería", Stadium="Jaraguay", FoundedDate=DateTime.Parse("2012-01-01") },
                new() { Name="Alianza Valledupar FC", City="Valledupar", Stadium="Armando Maestre", FoundedDate=DateTime.Parse("2003-01-01") },
                new() { Name="Fortaleza FC", City="Bogotá", Stadium="Metropolitano de Techo", FoundedDate=DateTime.Parse("2019-01-01") },
                new() { Name="Llaneros FC", City="Villavicencio", Stadium="Bello Horizonte", FoundedDate=DateTime.Parse("2018-01-01") },
                new() { Name="Cúcuta Deportivo", City="Cúcuta", Stadium="General Santander", FoundedDate=DateTime.Parse("1924-01-01") },
                new() { Name="Internacional de Bogotá", City="Bogotá", Stadium="Metropolitano de Techo", FoundedDate=DateTime.Parse("2011-01-01") },
            };
            ...
            {
                await context.TournamentTeams.AddAsync(new TournamentTeam
                {
